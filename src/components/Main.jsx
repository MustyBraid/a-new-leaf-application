...
const Main = () => {
  return (
    ...
    <div name='skills' className='w-full h-screen bg-white text-zinc-400'> {/* Container */} <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
